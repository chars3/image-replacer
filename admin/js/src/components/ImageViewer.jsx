              ...
              <table className="ir-w-full ir-text-sm">
                <tbody>
                  <tr>
                    ...
                    <td className="ir-py-1 ir-truncate ir-max-w-xs">{selectedImage.src}</td>
                  </tr>
                  {selectedImage.alt && (
                    <tr>
                  ...
                  {selectedImage.width && (
                    <tr>
                      ...
                      <td className="ir-py-1">{selectedImage.width} × {selectedImage.height}</td>
                    </tr>
                  )}
                  {selectedImage.attachment_id && (
                    <tr>
                      <td className="ir-py-1 ir-pr-4 ir-font-medium">ID do Attachment:</td>
